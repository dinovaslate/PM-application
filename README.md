...
Fitur AI Brief dan chatbot PMO tidak memakai OpenAI secara default. Chatbot juga bisa membuat chart dari snapshot dashboard dan mendukung satu gambar kecil per pesan untuk dianalisis bersama data. Untuk opsi gratis, buat API key dari Google AI Studio, lalu set environment variable di Vercel:
